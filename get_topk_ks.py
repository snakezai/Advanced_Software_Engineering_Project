...
def main(params, testmodel):
    ...
    for i in range(1, 11):
        with open("./configs/ks_get_congfig.json") as fin:
            ...
            # 更换kt时这里也要换
            data_config["test_file"] = f'model/{testmodel}/Topk_insert_data/top{i}_insert_testdata.csv'
        ...
        torch.save(stu_ks, os.path.join(dpath, f'model/{testmodel}/top{i}_pkc.pth'))
