...
def main(params, head_id, testmodel):
    ...
    for i in range(1, 11):
        with open("../configs/data_config.json") as fin:
            ...
            # 更换kt时这里也要换
            data_config["test_file"] = f'model/{testmodel}/head_{head_id}/Topk_insert_data/top{i}_insert_testdata.csv'
        ...
        os.makedirs(os.path.join(dpath, f'model/{testmodel}/head_{head_id}'), exist_ok=True)
        torch.save(stu_ks, os.path.join(dpath, f'model/{testmodel}/head_{head_id}/top{i}_pkc.pth'))
